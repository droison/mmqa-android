...
public class HTTP {
    ...
    public static HttpResponseEntity postByHttpUrlConnection(String pathUrl,Object o){
        ...
        try{
         ...
         String sessionid =  HttpDataService.sessionId;
			if(sessionid != null)
			{	
				httpConn.setRequestProperty("Cookie", "JSESSIONID=" + sessionid);
				Log.v("JSESSIONID:", sessionid);
			}
              
         httpConn.setRequestProperty("name", "question");
    ...
    public static HttpResponseEntity get(String url) {
		...
		try {
			...
			if(sessionid != null)
			{	
				listGet.setHeader("Cookie", "JSESSIONID=" + sessionid);
				Log.v("JSESSIONID:", sessionid);
			}
